  ...
  return (
    <LazyMotion features={domAnimation}>
      <section className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
        ...
        {/* Countdown Banner - replacing stats banner */}
        <m.div
          variants={{
            hidden: { opacity: 0, y: -20 },
            visible: { 
          ...
          className="mb-14  rounded-xl p-2 shadow-lg overflow-hidden relative group"
        >
          {/* Subtle animated background glow */}
          <div className="absolute inset-0 bg-gradient-to-r from-purple-600/5 via-transparent to-purple-600/5 opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
          
          <div className="flex flex-col items-center justify-center relative z-10">
            <div className="flex items-center gap-3 mb-2">
              <FaClock className="text-purple-400" />
              <h3 className="text-transparent bg-clip-text bg-nuvo-gradient-text text-lg font-semibold">NUVOS Token Pre-Sale Countdown</h3>
            </div>
            ...
            <div className="grid grid-cols-4 gap-2 sm:gap-4 w-full max-w-lg">
              {[
                ...
                <div key={index} className="text-center">
                  <div className="bg-black/40 border border-purple-500/30 rounded-lg py-2 px-1 sm:py-3">
