    ...
    <div className="min-h-screen pt-4 bg-gradient-to-b from-gray-900 via-purple-900 to-gray-900">
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 mb-8">
            {/* Token Distribution */}
            <motion.div
                className="bg-black/30 backdrop-blur-sm rounded-xl p-6 shadow-xl border border-purple-500/30 hover:border-purple-500/50 transition-all duration-300"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
            ...
            >
                ...
                <div className="aspect-square max-w-[280px] mx-auto hover:scale-105 transition-transform duration-300">
                    <Pie data={tokenDistributionData} />
                </div>
                <div className="mt-6 space-y-4">
                    <h3 className="text-lg font-semibold text-purple-400 mb-2 tracking-wide">
                        Key Points
                    </h3>
                    <ul className="grid grid-cols-1 gap-3 text-sm md:text-base text-gray-300">
                        ...
                        {/* Revenue Streams */}
            <motion.div
                className="bg-black/30 backdrop-blur-sm rounded-xl p-6 shadow-xl border border-purple-500/30 hover:border-purple-500/50 transition-all duration-300"                            initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
            ...
            >
                ...
                <div className="aspect-square max-w-[280px] mx-auto hover:scale-105 transition-transform duration-300">
                    <Pie data={revenueStreamsData} />
                </div>
                <div className="mt-4 md:mt-6">
                    <h3 className="text-lg font-semibold text-purple-400 mb-2">
                        Strategy
                    </h3>
                    <ul className="grid grid-cols-1 gap-2 text-sm md:text-base text-gray-300">
        ...
        {/* Key Metrics Section */}          
        <div className="grid grid-cols- md:grid-cols-3 gap-6 mb-12">
